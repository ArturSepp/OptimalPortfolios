"""Local diagnostics for maximum-diversification portfolio optimisation."""
import numpy as np
import pandas as pd
...
def run_local(local: Locals):
    ...
    if local == Locals.MAX_DIVERSIFICATION_SIMPLE:
    ...
    elif local == Locals.MAX_DIVERSIFICATION_WITH_BOUNDS:
    ...
    elif local == Locals.MAX_DIVERSIFICATION_ROLLING:
        import qis as qis
...
if __name__ == '__main__':
    ...
    run_local(local=Locals.MAX_DIVERSIFICATION_WITH_BOUNDS)
