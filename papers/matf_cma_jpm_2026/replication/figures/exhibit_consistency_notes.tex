...
%
% fig:declared_delta — median |Delta|: historical 0.63%, MATF 0.47%; maximum historical 5.60%.
%   MATF reconciliation to the declared channels: 1.2e-16. The R2 text's machine-zero claim of
...
%   volatility 9.30%. Idiosyncratic share of
%   active variance: MATF 79%, historical mean 58%.
