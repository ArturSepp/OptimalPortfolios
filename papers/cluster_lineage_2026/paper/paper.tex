...
public-reproduction ruling. The journal supports Open Science Badges (COS):
the Open Materials badge fits the code-public/data-proprietary split, and a
deposited replication archive with a DOI (e.g.\ Zenodo, as for the CSDA
paper) supports both this statement and the badge application, which is made
on acceptance.}
